				       ...
				       const int droppedFrames)
{
	...
	double time_per_line = seconds_per_line <= d_time_per_fft ? d_time_per_fft : d_avg_acquisition_time;
	double centerTime = 0;
...
//			timeScale->setSecondsPerLine(acquisitionTime);
//			timeScale->setCenterTime(centerTime);
//			timeScale->initiateUpdate();

//			((WaterfallZoomer*)d_zoomer[0])->setSecondsPerLine(acquisitionTime);
